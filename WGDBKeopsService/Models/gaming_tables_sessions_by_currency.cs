...
public partial class gaming_tables_sessions_by_currency
{
    ...
    [Column(TypeName = "money")]
    public decimal gtsc_copy_dealer_validated_amount { get; set; }

    [Column(TypeName = "money")]
    public decimal gtsc_actual_amount { get; set; }

    [Column(TypeName = "money")]
    public decimal gtsc_actual_chips_amount { get; set; }

    [Column(TypeName = "money")]
    public decimal gtsc_actual_credit_chips_amount { get; set; }

    [Column(TypeName = "money")]
    public decimal gtsc_deposits_amount { get; set; }

    [Column(TypeName = "money")]
    public decimal? gtsc_tax { get; set; }
}
