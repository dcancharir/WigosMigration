...
using WGDBDatawareHouseClient.Winmeier.Context;
using WGDBDatawareHouseClient.Winmeier.Models;

namespace WGDBDatawareHouseClient.Controllers;
[Route("api/winmeiermigration")]
[ApiController]
public class WinmeierMigrationController : ControllerBase
{
    wgdb_000_winmeierContext _context;
    private readonly ILogger<WinmeierMigrationController> _logger;
    public WinmeierMigrationController(wgdb_000_winmeierContext context, ILogger<WinmeierMigrationController> logger)
    {
        _context = context;
        _logger = logger;
    }
