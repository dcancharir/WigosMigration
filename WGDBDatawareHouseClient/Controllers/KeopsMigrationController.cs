...
using WGDBDatawareHouseClient.Keops.Context;
using WGDBDatawareHouseClient.Keops.Models;
using WGDBDatawareHouseClient.Utilities;
using System.Linq.Expressions;

namespace WGDBDatawareHouseClient.Controllers;
[ApiController]
[Route("api/keopsmigration")]
public class KeopsMigrationController : ControllerBase
{
    wgdb_000_keopsContext _context;
    private readonly ILogger<KeopsMigrationController> _logger;
    public KeopsMigrationController(wgdb_000_keopsContext context, ILogger<KeopsMigrationController> logger)
    {
        _context = context;
        _logger = logger;
    }
