...
public partial class account_flag
{
    ...
    public long? af_added_by_operation_id { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? af_spented_datetime { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? af_spented_user_id { get; set; }

    public long? af_added_by_draw_id { get; set; }
}
