...
[Index("cue_voucher_sequence", Name = "IX_cue_voucher_sequence")]
...
public partial class customer_entrance
{
    ...
    public int? cue_site_id { get; set; }

    public byte[]? cue_timestamp { get; set; }

    [Column(TypeName = "decimal(10, 2)")]
    public decimal? cue_accounting_price { get; set; }

    public long? cue_invoice_number { get; set; }

    public int? cue_payment_method { get; set; }

    [Column(TypeName = "datetime")]
    public DateTime? cue_cancellation_datetime { get; set; }

    public int? cue_cancellation_user_id { get; set; }

    public long? cue_cancellation_voucher_id { get; set; }

    public long? cue_cancellation_invoice_number { get; set; }
}
